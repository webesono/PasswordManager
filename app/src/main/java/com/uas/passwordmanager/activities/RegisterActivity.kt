...
import com.uas.passwordmanager.databinding.ActivityRegisterBinding
...
class RegisterActivity : AppCompatActivity() {
    ...
    private fun setListeners(){
        binding.btnRegister.setOnClickListener{
            ...
            var image = intent.getStringExtra("encodedImage").toString()

            if (image == "null"){
            image = Constants.DEFAULT_IMAGE_PROFILE
        }

            if (notEmpty(nama, email, pass)){
    ...
    private fun notEmpty(nama: String, email:String, pass: String):Boolean {
        if (nama.isEmpty()){
